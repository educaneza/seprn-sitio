...
function manejarAlta(datos) {
  ...
  // (QA-NOTES #44). Columnas capturadas por el solicitante: A-Q: de Fecha a Observaciones.
  const registro = registrarSolicitudSinDuplicar_(hoja, fila, 17, altaGenerarFolio, datos.idEnvio);
